...
export function DashboardPage({ setPage }: DashboardPageProps) {
  ...
  const handleAnalyze = async () => {
    ...
    try {
      ...
      const parsed = parseVectraOutput(data.result ?? '')
      ...
      const historyItem = {
        ...
        score: parsed.feasibilityScore,
        verdict: (parsed as any).scoreVerdict ?? 'ANALYSIS COMPLETE',
        status: 'DEPLOYED',
      }
    ...
    <div style={{ display: 'grid', gridTemplateColumns: '1fr 240px', minHeight: 'calc(100vh - 84px)' }}>
      ...
      <div style={{ padding: 28, overflowY: 'auto', display: 'flex', flexDirection: 'column', gap: 20 }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 12 }}>
          ...
          <div style={{ background: '#080C15', border: '1px solid #1E293B', borderRadius: 8, padding: '16px 20px' }}>
            <div style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 9, color: '#64748B', letterSpacing: '0.12em', marginBottom: 8 }}>
              CORE RISK COUNT
            </div>
            <div style={{ display: 'flex', alignItems: 'baseline', gap: 10 }}>
              <span style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 30, fontWeight: 700, color: '#EF4444', lineHeight: 1 }}>
                03
              </span>
          ...
          <div style={{ background: '#080C15', border: '1px solid #1E293B', borderRadius: 8, padding: '16px 20px' }}>
            ...
            <div style={{ fontFamily: "'Sora', sans-serif", fontSize: 15, fontWeight: 700, color: '#E6EEF8' }}>
              {DASHBOARD_STATS.recommendedPath}
            </div>
          </div>
          ...
          <div style={{ background: '#080C15', border: '1px solid #1E293B', borderRadius: 8, padding: '16px 20px' }}>
            ...
            <div style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 22, fontWeight: 700, color: '#10B981' }}>
              HIGH <span style={{ fontSize: 14 }}>↑</span>
            </div>
          </div>
        </div>
        ...
        <div style={{ background: '#05070F', border: '1px solid #1E293B', borderRadius: 10, padding: 22 }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 16 }}>
            <span style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 9, color: '#94A3B8', letterSpacing: '0.12em' }}>
              LIVE ANALYSIS PROGRESS
            </span>
            ...
            {['Parsing Concept', 'Extracting Assumptions', 'Ranking Paths'].map((step, i) => (
              <div key={i} style={{ flex: 1, paddingRight: i < 2 ? 24 : 0 }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: 6, marginBottom: 8 }}>
                  {i < 2 ? <CheckCircle2 size={12} color="#22D3EE" /> : <Circle size={12} color="#4A5568" />}
                  <span
                    style={{
                      fontFamily: "'Sora', sans-serif",
                      fontSize: 11,
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }}>
          <div style={{ background: '#05070F', border: '1px solid #1E293B', borderRadius: 10, padding: 22 }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 12 }}>
              <div>
                <div style={{ fontFamily: "'Sora', sans-serif", fontSize: 15, fontWeight: 700, color: '#E6EEF8', marginBottom: 4 }}>
                  Strategic Interpretation
                </div>
                <div style={{ fontFamily: "'Sora', sans-serif", fontSize: 11, color: '#64748B' }}>
                  Complexity: High-Order Systems
                </div>
              </div>
              <div style={{ textAlign: 'right' }}>
                <div style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 9, color: '#64748B', letterSpacing: '0.1em', marginBottom: 4 }}>
                  CONFIDENCE
                </div>
                <div style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 22, fontWeight: 700, color: '#22D3EE' }}>
                  92.4%
                </div>
              </div>
            </div>
          ...
          <div style={{ background: '#05070F', border: '1px solid #1E293B', borderRadius: 10, padding: 22 }}>
            <div style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 9, color: '#94A3B8', letterSpacing: '0.12em', marginBottom: 14 }}>
              CRITICAL WEAKNESSES
            </div>
            ...
            {[
              {
                ...
                desc: 'Inefficient gas routing during peak volatility could erode margins by 12%.',
              },
              {
                Icon: AlertCircle,
                color: '#F59E0B',
                ...
                desc: 'User onboarding requires 4 distinct wallet signatures. Abandonment risk: Moderate.',
              },
              ...
              >
                ...
                <p style={{ fontFamily: "'Sora', sans-serif", fontSize: 11, color: '#94A3B8', lineHeight: 1.5 }}>
                  {desc}
                </p>
              </div>
            ))}
        ...
        >
          ...
          <div style={{ display: 'flex', gap: 32 }}>
            <div>
              <div style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 9, color: '#64748B', letterSpacing: '0.12em', marginBottom: 4 }}>
                TIME TO MARKET
              </div>
            ...
            <div>
              ...
              <div style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 18, fontWeight: 700, color: '#10B981' }}>
                420% (Yr 1)
              </div>
            </div>
          </div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }}>
          <div style={{ background: '#05070F', border: '1px solid #1E293B', borderRadius: 10, padding: 22 }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 16 }}>
              ...
              <span style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 9, color: '#22D3EE', letterSpacing: '0.15em' }}>
                CORE MVP BUILD
              </span>
            </div>
          ...
          <div style={{ background: '#05070F', border: '1px solid #1E293B', borderRadius: 10, padding: 22 }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 16 }}>
              ...
              <span style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 9, color: '#EF4444', letterSpacing: '0.15em' }}>
                DO NOT BUILD
              </span>
            </div>
        ...
        {/* 7-step roadmap */}
        <div style={{ background: '#05070F', border: '1px solid #1E293B', borderRadius: 10, padding: 22 }}>
          <div style={{ fontFamily: "'Sora', sans-serif", fontSize: 15, fontWeight: 700, color: '#E6EEF8', marginBottom: 20 }}>
            7-Step Strategic Roadmap
          </div>
          ...
          {ROADMAP_STEPS.map(({ n, color, label, desc }, i) => (
            <div key={i} style={{ display: 'flex', gap: 16, marginBottom: 18 }}>
              ...
              <div>
                <div style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 10, color: '#4F7CFF', letterSpacing: '0.1em', marginBottom: 4 }}>
                  {label}
                </div>
          ...
          <div style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 10, color: '#4A5568', marginTop: 4 }}>
            STEPS 04-07 SECURED...
          </div>
        </div>
      </div>
      ...
      >
        ...
        <div style={{ background: '#05070F', border: '1px solid #1E293B', borderRadius: 10, padding: 20, textAlign: 'center' }}>
          <div style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 9, color: '#64748B', letterSpacing: '0.12em', marginBottom: 16 }}>
            STRATEGY CONFIDENCE
          </div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 10, marginTop: 16 }}>
            <div style={{ textAlign: 'center' }}>
              ...
              <div style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 18, fontWeight: 700, color: '#E6EEF8' }}>
                0.08
              </div>
            </div>
            <div style={{ textAlign: 'center' }}>
        ...
        <div style={{ background: '#05070F', border: '1px solid #1E293B', borderRadius: 10, overflow: 'hidden' }}>
          <div style={{ background: '#0C1018', padding: '8px 14px', display: 'flex', alignItems: 'center', gap: 6 }}>
            ...
            <span style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 9, color: '#94A3B8', letterSpacing: '0.1em' }}>
              NODE TOPOLOGY
            </span>
          </div>
